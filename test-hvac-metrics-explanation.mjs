 ...
 * Using .mjs extension to support ES modules
 */

// Main test function
const testHvacMetricsService = async () => {
  console.log('Testing HvacMetricsExplanationService...');
  
  // Dynamically import the service
  try {
    // Import using dynamic import
    const module = await import('./backend/src/services/hvacMetricsExplanationService.js');
    const HvacMetricsExplanationService = module.default;
