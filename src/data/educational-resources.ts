...
export const mockResources: EducationalResource[] = [
  ...
  },
  {
    ...
    description: 'Smart energy moves for every season to keep your home comfortable and efficient year-round.',
    type: 'article',
    topic: 'energy-saving',
    level: 'beginner',
    readTime: '10 min read',
    thumbnail: 'https://placehold.co/400x250?text=Seasonal+Tips',
    url: '/education/resources/seasonal-energy-tips',
    datePublished: '2025-04-23',
    featured: true,
    collectionIds: ['getting-started', 'seasonal-tips', 'interactive-learning'],
    tags: ['seasonal', 'tips', 'saving', 'quick-wins', 'interactive', 'checklist'],
    popularity: 1845,
    rating: {
      average: 4.5,
      count: 167
