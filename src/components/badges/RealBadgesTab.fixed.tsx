 ...
 */
function prepareBadgesForDisplay(allBadges: Badge[] | null | undefined, userBadges: any[] | null | undefined): Badge[] {
  ...
  userBadges.forEach(userBadge => {
    ...
    // Find the matching badge definition
    const badgeDefinition = allBadges.find(b => b && b.id === badgeId);
