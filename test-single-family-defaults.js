// Simple test script to verify the implementation of single-family home defaults

const { getSingleFamilyConstructionPeriod, getSingleFamilySizeCategory, getSingleFamilyDefaults } = require('./src/components/audit/forms/housingTypeDefaults');
