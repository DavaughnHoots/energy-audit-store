/**
 * Minimal database fix to ensure analytics tables exist
 * Uses only built-in modules with direct SQL
 */
...
async function createTables() {
  console.log('Starting minimal analytics tables fix...');
  ...
  try {
    ...
    // Create analytics_sessions table first (for foreign key constraints)
    ...
    // Create consent enum type if it doesn't exist
