...
// Import the fixed direct-admin routes
import directAdminRoutes from './routes/direct-admin.fixed.js';
...
const server = app.listen(PORT, () => {
  appLogger.info('Server started (ANALYTICS DASHBOARD FIX)', createLogMetadata(undefined, {
    port: PORT,
    nodeEnv: process.env.NODE_ENV,
    version: 'dashboard-fix'
  }));
});
