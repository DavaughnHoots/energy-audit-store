...
} from './src/components/audit/forms/duplexDefaults';
...
function testDuplexDefaults() {
  ...
  console.log('- Construction Period for 1975: ' + getDuplexConstructionPeriod(1975));
  console.log('- Construction Period for 1990: ' + getDuplexConstructionPeriod(1990));
  console.log('- Construction Period for 2010: ' + getDuplexConstructionPeriod(2010));
  console.log('- Size Category for 1200 sq ft: ' + getDuplexSizeCategory(1200));
  console.log('- Size Category for 2000 sq ft: ' + getDuplexSizeCategory(2000));
  console.log('- Size Category for 2800 sq ft: ' + getDuplexSizeCategory(2800));
  console.log('- Unit Configuration (default): ' + getDuplexUnitConfiguration());
  console.log('- Unit Configuration (stacked): ' + getDuplexUnitConfiguration('stacked'));
  console.log('- Unit Configuration (front-to-back): ' + getDuplexUnitConfiguration('front-to-back'));
  
  // Test Case 1: Pre-1980 small duplex
  const preEightiesSmall = getDuplexDefaults(1970, 1000, 'NY', 'side-by-side');
  ...
  const midEraStacked = getDuplexDefaults(1990, 1800, 'FL', 'stacked');
  ...
  const newLargeFrontToBack = getDuplexDefaults(2010, 2800, 'AZ', 'front-to-back');
  ...
  const climateTest = [
    getDuplexDefaults(2010, 1800, 'MN', 'side-by-side'), // Cold
    getDuplexDefaults(2010, 1800, 'VA', 'side-by-side'), // Mixed-humid
    getDuplexDefaults(2010, 1800, 'FL', 'side-by-side'), // Hot-humid
    getDuplexDefaults(2010, 1800, 'AZ', 'side-by-side')  // Hot-dry
  ];
  ...
  const configTest = [
    getDuplexDefaults(2010, 1800, 'VA', 'side-by-side'),
    getDuplexDefaults(2010, 1800, 'VA', 'stacked'),
    getDuplexDefaults(2010, 1800, 'VA', 'front-to-back')
  ];
