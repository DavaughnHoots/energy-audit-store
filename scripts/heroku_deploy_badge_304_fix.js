...
const COMMIT_MESSAGE = 'Fix badge authentication 304 Not Modified responses with cache busting';
...
try {
  ...
  console.log('1. Added cache-busting headers to prevent 304 Not Modified responses');
  console.log('2. Added fallback to extract user data from token info if profile data missing');
