// Script to update a user's role to admin in the database - designed for Heroku execution
const userId = '51324b2b-39d6-486d-875b-04d0f103c49a'; // The user ID from the logs

// This script is meant to be executed on Heroku via: heroku run node scripts/heroku_update_user_role.js
async function updateUserRole() {
  try {
    console.log('Heroku script: Updating user role to admin');
    
    // Dynamically import the pg package (ES modules on Heroku)
